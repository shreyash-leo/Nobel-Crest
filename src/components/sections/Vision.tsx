    ...
    <section className="bg-[#0E1228] py-32 px-10">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20">
        ...
        <div>
          ...
          <h2 className="text-6xl leading-tight text-[#EBB337] mb-8 font-bold">
            Redefining Luxury
            <br />
            Real Estate Experiences
          </h2>
          <p className="text-lg leading-9 text-white max-w-xl">
        ...
        <div className="grid grid-cols-2 gap-10">
          ...
          <div className="border border-[#EBB337]/40 p-10 bg-[#0E1228] shadow-md hover:shadow-lg hover:shadow-[#A57C3E]/10 transition-all duration-300 hover:border-[#A57C3E]/60">
            ...
            <p className="text-white font-medium">Properties Curated</p>
          </div>
          <div className="border border-[#EBB337]/40 p-10 bg-[#0E1228] shadow-md hover:shadow-lg hover:shadow-[#A57C3E]/10 transition-all duration-300 hover:border-[#A57C3E]/60">
          ...
          <div className="border border-[#EBB337]/40 p-10 bg-[#0E1228] shadow-md hover:shadow-lg hover:shadow-[#A57C3E]/10 transition-all duration-300 hover:border-[#A57C3E]/60">
            ...
            <p className="text-white font-medium">Luxury Cities</p>
          </div>
        </div>
      </div>
    </section>
